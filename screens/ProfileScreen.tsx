...
export default function ProfileScreen({
  ...
  return (
    ...
    >
      ...
      <Image
        style={styles.avatar}
        source={require('../assets/images/avatar_5.png/')}
      />
      ...
      <View style={styles.iconBar}>
        <Image
          style={styles.icon}
          source={require('../assets/images/green-covid.png/')}
        />
        <Image
          style={styles.icon}
          source={require('../assets/images/green-student.png/')}
        />
        <Image
          style={styles.icon}
          source={require('../assets/images/green-phone.png/')}
        />
        <Image
          style={styles.icon}
      ...
      <View style={styles.covidStatus}>
        ...
        <View style={styles.subgrid2}>
          ...
          {/* Right Division */}
          <Text style={styles.covidRight}>
            I feel okay meeting outside for coffee or food
          </Text>
        </View>
      </View>
      ...
      <View style={styles.interestBar}>
        <Text style={[styles.subtitle, { marginTop: '5%', color: 'black' }]}>
          Interests
        </Text>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    paddingTop: 0.02 * windowHeight /* 20 */,
